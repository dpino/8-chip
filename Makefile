...
chip8-main: src/chip8-main.c
	gcc ${CFLAGS} ${LIBS} src/chip8-main.c -o chip8-main ${SDL2}

chip8-asm: src/assembler.c
	gcc ${CFLAGS} ${LIBS} src/assembler.c -o chip8-asm ${SDL2}

chip8-disasm: src/disassembler.c
	gcc ${CFLAGS} ${LIBS} src/disassembler.c -o chip8-disasm ${SDL2}

chip8-test: src/chip8-test.c
	gcc ${CFLAGS} ${LIBS} src/chip8-test.c -o chip8-test ${SDL2}

chip8-repl: src/chip8-repl.c src/parser.c
	gcc ${CFLAGS} ${LIBS} src/chip8-repl.c -o chip8-repl ${SDL2}
